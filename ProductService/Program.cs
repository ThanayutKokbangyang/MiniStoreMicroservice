...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console(outputTemplate: "[{Timestamp:HH:mm:ss} {Level:u3}] [ProductSvc] {Message:lj}{NewLine}{Exception}")
    .WriteTo.File("logs/productservice-.log", rollingInterval: RollingInterval.Day, retainedFileCountLimit: 30)
...
Log.Information("ProductService started on {Environment}", app.Environment.EnvironmentName);
app.Run();